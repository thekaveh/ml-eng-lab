...
> **Tip:** GitHub may show "Unable to render code block" on output cells with large matplotlib PNGs. [View this notebook on nbviewer](https://nbviewer.org/github/thekaveh/ml-eng-lab/blob/main/notebooks/dim_reduction-iris-autoencoder-pytorch/notebook.ipynb) for full rendering.
...
## 7. Sibling: `notebooks/clustering-iris-kmeans-vs-ae-pytorch/`

The unsupervised-clustering counterpart on the same AE recipe lives at [`../notebooks/clustering-iris-kmeans-vs-ae-pytorch/`](../clustering-iris-kmeans-vs-ae-pytorch/) — KMeans on raw 4-D features vs on the 2-D AE latent, scored with ARI + NMI vs the true species labels.
