...
Three modes, pick by use case. Mode 2 is the default for most ml-eng-lab work as of genai-vanilla `b96a292` — the image ships ml-eng-lab's external dependencies, `thekaveh-nnx[lm]==0.2.0`, and NLP assets.
